...
4. Nếu cần thao tác sâu, đọc theo thứ tự `01` -> `07` trong `docs/ai/` (trong đó `06` mô tả toast, modal xác nhận và lỗi API store; `07` mô tả skeleton loading khi client chờ API).
